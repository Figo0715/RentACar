...
namespace Business.Concrete
{
    public class UserManager : IUserService
    {
        ...
        {
            var rulesResult = BussinessRules.Run(CheckIfEmailExist(user.Email));
            if (rulesResult != null)
            {
                return rulesResult;
            }
        ...
        {
            var rulesResult = BussinessRules.Run(CheckIfUserIdExist(user.Id)
        ...
        {
            var rulesResult = BussinessRules.Run(CheckIfUserIdExist(userDto.Id)
        ...
        {
            var rulesResult = BussinessRules.Run(CheckIfUserIdExist(userId));
            if (rulesResult != null)
            {
                return rulesResult;
            }
